...
// Fetch unread count
$unread_response = api_get('/api/notifications/unread-count');
$unread = $unread_response['success'] ? $unread_response['count'] : 0;

// Fetch dashboard stats
$stats_response = api_get('/api/dashboard/stats');
$stats = $stats_response['success'] ? $stats_response['stats'] : array();
$ai_insights = $stats_response['success'] ? (isset($stats_response['ai_insights']) ? $stats_response['ai_insights'] : array()) : array();

// Fetch recent loans
$loans_response = api_get('/api/loans');
$loans = $loans_response['success'] ? array_slice($loans_response['loans'], 0, 5) : array();
?>
<!DOCTYPE html>
...
<body>
    ...
    <div class="main-content">
        ...
        <div class="p-3 p-md-4">
            <?php if ($flash): ?>
            <div class="alert <?php echo alert_class($flash['type']); ?> alert-dismissible fade show" role="alert">
            ...
            <div class="row g-3 mb-4">
                <div class="col-sm-6 col-xl-3">
                    <div class="stat-card">
                        ...
                        <div class="value"><?php echo format_money(isset($stats['total_loaned']) ? $stats['total_loaned'] : 0); ?></div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="stat-card">
                        ...
                        <div class="value"><?php echo format_money(isset($stats['total_outstanding']) ? $stats['total_outstanding'] : 0); ?></div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="stat-card">
                        ...
                        <div class="value"><?php echo format_money(isset($stats['total_collected']) ? $stats['total_collected'] : 0); ?></div>
                ...
                <div class="col-sm-6 col-xl-3">
                    <div class="stat-card">
                        ...
                        <div class="value"><?php echo isset($stats['overdue_count']) ? $stats['overdue_count'] : 0; ?></div>
            ...
            <div class="row g-3 mb-4">
                <div class="col-md-4">
                    <div class="stat-card text-center">
                        <div class="value" style="color: #58a6ff;"><?php echo isset($stats['active_loans']) ? $stats['active_loans'] : 0; ?></div>
                        <div class="label">Active Loans</div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="stat-card text-center">
                        <div class="value" style="color: #d29922;"><?php echo isset($stats['pending_loans']) ? $stats['pending_loans'] : 0; ?></div>
                        <div class="label">Pending Approval</div>
                    </div>
                </div>
                <div class="col-md-4">
                    <div class="stat-card text-center">
                        <div class="value" style="color: #3fb950;"><?php echo isset($stats['total_clients']) ? $stats['total_clients'] : 0; ?></div>
            ...
            <div class="table-card mb-4">
                <div class="p-3 border-bottom" style="border-color: var(--border) !important;">
                    <h6 class="mb-0"><i class="bi bi-robot me-2" style="color: var(--accent);"></i>AI Portfolio Insights</h6>
                </div>
                <div class="p-3">
                    <?php foreach ($ai_insights as $insight): ?>
                    <div class="d-flex gap-2 mb-2">
                        <i class="bi bi-lightbulb" style="color: var(--accent);"></i>
                        <span><?php echo h($insight); ?></span>
                    </div>
                    <?php endforeach; ?>
                </div>
            </div>
            ...
            <div class="table-card">
                ...
                <div class="table-responsive">
                    <table class="table">
                        ...
                        <tbody>
                            <?php if (empty($loans)): ?>
                            <tr><td colspan="5" class="text-center text-muted py-4">No loans found</td></tr>
                            <?php else: ?>
                                <?php foreach ($loans as $loan): ?>
                                <tr>
                                    <td><strong><?php echo h($loan['loan_number']); ?></strong></td>
                                    <td><?php echo h(isset($loan['client_name']) ? $loan['client_name'] : '-'); ?></td>
                                    <td><?php echo format_money($loan['principal']); ?></td>
                                    <td><?php echo format_money($loan['balance']); ?></td>
                                    <td>
                                        <?php
                                        $status = strtolower(isset($loan['status']) ? $loan['status'] : 'pending');
